...
func (c *SAPAPICaller) Characteristic(characteristic string) {
	charcData, err := c.callCharacteristicSrvAPIRequirementCharacteristic("A_ClfnCharacteristicForKeyDate", characteristic)
	if err != nil {
		c.log.Error(err)
		return
	}
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": charcData, "function": "CharacteristicCharacteristic"})
	if err != nil {
		c.log.Error(err)
		return
	}
	...
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": valueData, "function": "CharacteristicValue"})
	if err != nil {
		c.log.Error(err)
		return
	}
	...
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": charcDescriptionData, "function": "CharacteristicCharcDescription"})
	if err != nil {
		c.log.Error(err)
		return
	}
	...
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": valueDescriptionData, "function": "CharacteristicValueDescription"})
	if err != nil {
		c.log.Error(err)
		return
	}
...
func (c *SAPAPICaller) CharcDescription(charcLanguage, charcDescription string) {
	data, err := c.callCharacteristicSrvAPIRequirementCharcDescription("A_ClfnCharcDescForKeyDate", charcLanguage, charcDescription)
	if err != nil {
		c.log.Error(err)
		return
	}
	err = c.outputter.Send(c.outputQueues[0], map[string]interface{}{"message": data, "function": "CharacteristicCharcDescription"})
	if err != nil {
		c.log.Error(err)
		return
	}
